...
docpadConfig = {
	...
	templateData:
		...
		site:
			...
			title: "ReDBox JDBC-Dataset Harvester"

			# The website description (for SEO)
			description: """
				Documentation for the JDBC to ReDBox Dataset Harvester.
				"""
			...
			subProjectName: "JDBC Dataset Harvester"
		...
		development: # Default
			...
			templateData:
				site:
					...
					project: "redbox-dataset-jdbc-harvester-template"
				parent:
